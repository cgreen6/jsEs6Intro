...
#Repositories - repo. folders, a directory, all projects are repo

#Warning*
# -system directory as a repo (Desktop, Docs, Application)
# -never create a repp in another repo (redunduancy)
# delete .git
  # rm -rf .git    (deletes a git file)

# Configure git


# puts "Amanita muscaria".upcase()
